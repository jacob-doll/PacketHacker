...
namespace PacketHacker
{
    namespace UI
    {
        ...
        {
        public:
            explicit ByteTable(int intialSize);
        ...
        {
        public:
            explicit ByteViewer(wxWindow *parent,
            ...
            void SetByte(uint32_t offset, uint8_t byte);
            void WriteInt(uint32_t offset, uint64_t val, uint32_t size);
